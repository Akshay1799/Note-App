...
const FormInput = ({setNotes,editingNote, onUpdate}) => {
    ...
    return (
        <div className='flex justify-center sticky flex-col items-center m-8 '>
            <h2 className='font-mono text-black text-2xl  md:text-3xl font-bold mt-8 mask-b-from-fuchsia-500 mx-auto   '>Got an idea? Write it down</h2>
            <div className='mx-auto animate-pulse relative flex justify-center items-center flex-col w-2xl  py-8 mt-8 my-8 border rounded-2xl shadow-lg/20 bg-blur  '>
