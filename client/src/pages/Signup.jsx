...
const Signup = () => {
  return (
    <div className='mt-8'>
      <form className='border flex flex-col justify-center mx-auto 0 shadow-xl w-xl  px-5 py-4 gap-4 rounded-xl'>
        <h2 className='flex justify-center font-bold text-2xl my-4 '>Register</h2>
        <div className='relative flex justify-center items-center'>
          <label htmlFor="username"><FaRegUser className='absolute ml-4 -mt-2 text-lg' /></label>
          <input id='username' type="text"  placeholder='Name' className='w-xs pl-12 py-2 bg-gray-100 rounded-3xl' />
        </div>
        <div className='relative flex justify-center items-center'>
          <label htmlFor="email"><MdOutlineEmail className='absolute ml-4 -mt-2 text-lg'/></label>
          <input id='email' type='email' placeholder='Email' className='w-xs pl-12 py-2 bg-gray-100 rounded-3xl ' />
        </div>
        <div className='relative flex justify-center items-center'>
          <label htmlFor="Password"><MdLockOutline className='absolute ml-4 -mt-2 text-lg'/></label>
